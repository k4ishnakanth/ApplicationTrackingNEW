    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationStatusUpdates", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "JobPostings",
                columns: new[] { "Id", "IsTechnical", "Title" },
                values: new object[,]
                {
                    { 1, true, "Senior Software Engineer" },
                    { 2, true, "Junior Developer" },
                    { 3, false, "HR Executive" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "password1", "Applicant", "applicant1" },
                    { 2, "password2", "BotMimic", "botmimic" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationStatusUpdates_ApplicationId",
